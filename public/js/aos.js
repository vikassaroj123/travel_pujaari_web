            ...
            E(j.disable) || x
              ...
              : (document
                ...
                (function () {
                      ...
                      if (mutation.type === "childList") {
                        mutation.removedNodes.forEach((removedNode) => {
                          if (
                            ...
                            (0, f.default)(S, 50, true); // Adjust this according to your logic
                          }
                        });
                      }
                    }
                  ...
                  // Configuration of the observer: look for nodes being removed
                  var config = { childList: true, subtree: true };

                  // Start observing the document body
                  observer.observe(document.body, config);

                  // To stop observing at some point, you can call:
                  // observer.disconnect();
                })(),
